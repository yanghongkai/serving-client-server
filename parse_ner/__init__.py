...
class Ner():
    ...
    def load_dict(self):
        map_file_path = os.path.join(data_dir, "vocab", "maps.pkl")
...
if __name__ == "__main__":
    ...
    ner = Ner("ner", "ner")
    loc_str, time_str, year_str, month_str, day_str, part_str, speed_str, type_str = ner.predict(sents)
    fmt = ("sents:{}\n\n"
           "loc_str:{}\n"
           "time_str:{}\n"
           "year_str:{}\n"
           ...
           "speed_str:{}\n"
           "type_str:{}")
    print(fmt.format(sents, loc_str, time_str, year_str, month_str, day_str,
                     part_str, speed_str, type_str))
